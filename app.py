...
DEPARTMENT_OPTIONS = ["anesthesia", "gynecology", "radiotherapy", "surgery", "TB & Chest disease"]
WARD_TYPE_OPTIONS = ["Q", "R", "S", "Other Ward Types (P, T, U)"]
WARD_FACILITY_OPTIONS = ["A", "B", "C", "D", "E", "F"]
BED_GRADE_OPTIONS = [1.0, 2.0, 3.0, 4.0]
ADMISSION_OPTIONS = ["Emergency", "Trauma", "Urgent"]
SEVERITY_OPTIONS = ["Minor", "Moderate", "Extreme"]
